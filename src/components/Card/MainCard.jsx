...
export const MainCard = () => {
  ...
  return (
    <div className="max-centered">
      ...
      <main role="main">
        <Selector select={select} setSelect={setSelect} width={width} />
        {width > 600 ? select === "list" ? <ListCard List={data} /> : <GridCard List={data} /> : <CaroUsel List={data} />}
      </main>
      <aside className="banner banner-bottom" role="doc-tip" aria-label="Submit a name">
        <img
          ...
          srcSet={`${require("../../assets/img/bg-people.png")} 750w, ${require("../../assets/img/bg-people.@2x.png")} 1440w`}
